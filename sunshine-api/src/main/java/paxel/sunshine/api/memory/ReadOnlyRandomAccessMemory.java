...
public interface ReadOnlyRandomAccessMemory {
     ...
     * @throws IndexOutOfBoundsException in case the index is less than 0 or bigger than the RAM or the destination is bigger than the remaining bytes.
    ...
    /**
     * Test if the Implementation can write Bytes into the given Class. If the result is true, the {@link #copyToDestination(long, int, Object)} method should accept an instance as destination.
     *
